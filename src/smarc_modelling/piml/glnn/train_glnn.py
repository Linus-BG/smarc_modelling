...
from smarc_modelling.piml.glnn.utils.DynData import DynDataset, DynDatasetODE
...
if __name__ == "__main__":
    ...
    dataset_path = "src/smarc_modelling/piml/data/system_states_spin_and_straight.csv"
    n_dof = 6
    ...
    if save_model_params:
        torch.save(lnn.state_dict(), "src/smarc_modelling/piml/models/glnn.pt")